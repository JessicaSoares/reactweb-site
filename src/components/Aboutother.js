...
<section class="page-section bg-primary" id="about">
            ...
            <div class="container px-4 px-lg-5">
                ...
                <div class="row gx-4 gx-lg-5">
                        ...
                        <div class="mt-5">
                            <div class="mb-2"><i class="bi-gem fs-1 text-primary"> <AiOutlineAim color='#0f295a' /></i></div>
                            <h3 class="h4 mb-2">Objetivos</h3>
                            <ol class="text-muted mb-0"><li>• Contribuir para monitoramento de fatores de desempenho do Município;</li>
<li>• Transparência das ações relativas ao desenvolvimento econômico e infra-estrutural;</li>
<li>• Funcionar como ferramenta de apoio à gestão pública;</li>
...
<li>• <b>Outros</b>: Gênero, cultura, recreação e esporte, turismo, meio ambiente.</li></ol>
                    ...
                    <div class="col-lg-3 col-md-6 text-center">
                        <div class="mt-5">
                          ...
                          <li> • Comunidade Universitária e Estudantes do ensino Fundamental e Médio;</li>
                          <li> • Público em Geral;
